...
gTextures = {
    ...
    ['character-walk-carry'] = love.graphics.newImage('graphics/character_pot_walk.png'),
    ['character-pickup'] = love.graphics.newImage('graphics/character_pot_lift.png'),
    ['hearts'] = love.graphics.newImage('graphics/hearts.png'),
    ['switches'] = love.graphics.newImage('graphics/switches.png'),
    ['entities'] = love.graphics.newImage('graphics/entities.png'),
    ['bomb'] = love.graphics.newImage('graphics/bomb.png'),
    ['bombexploding'] = love.graphics.newImage('graphics/bombexploding.png')
}
...
gFrames = {
    ...
    ['character-walk-carry'] = GenerateQuads(gTextures['character-walk-carry'], 16, 32),
    ['character-pickup'] = GenerateQuads(gTextures['character-pickup'], 16, 32),
    ['entities'] = GenerateQuads(gTextures['entities'], 16, 16),
    ['hearts'] = GenerateQuads(gTextures['hearts'], 16, 16),
    ['switches'] = GenerateQuads(gTextures['switches'], 16, 18),
    ['bomb'] = GenerateQuads(gTextures['bomb'], 32, 32),
    ['bombexploding'] = GenerateQuads(gTextures['bombexploding'], 32, 32)
}
