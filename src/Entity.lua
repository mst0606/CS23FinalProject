...
function Entity:damage(dmg)
    ...
    --[[
    QUESTION 1 : "be careful it doesn’t go above the visual cap of 6, lest we appear to have a bug!"
     make sure we never exceed the maximum amount of health for this entity
    ]]
